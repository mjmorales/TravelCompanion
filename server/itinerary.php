...
$sql= "SELECT * FROM itinerary ORDER BY score DESC"; 
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                     ...
                     <li>
                       ...
                       <li>
                        <?php echo "<a href='/~mmoral41/CEN4010/server/friends.php?user=".$user."'>Itinerary</a>"; ?>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
...
<div class="row">
<div class="col-md-4 portfolio-item" style="padding-left:5%;bgcolor: Gray;">
    <h1 style="color:white;">View other's Itineraries!</h1>
    <p><?php if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<p>Title: ".$row["title"]."<br>"."Location: ".$row["location"]." Author: ".$row["username"]."    Score: ".$row["score"]."<br></p>";
        echo "<p>".$row["content"]."</p>";
        echo "<a href='/~mmoral41/CEN4010/server/scoreitinerary.php?user=".$user."&title=".$row["title"]."&score=".$row['score']."'>Like</a>    <br>";
    }
} else {
...
<h1 style="color:white;">Create an Itinerary!</h1>
    <div>
    <form id="itinerary" action="itinerarymake.php" method="get">
        <input type='hidden' name='user' value=<?php echo "'".$user."'"; ?>>
        <input type="text" name="title" value="Itinerary Title">
        <input type="text" name="location" value="Location">
        <textarea  rows="10" cols="100" name="content" form="itinerary">Enter notes:</textarea><br>
        <input type="submit">
    </form>
</div>
